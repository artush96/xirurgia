!function () {
    ...
    function b(t) {
        ...
        if (!e) return null;
        var n = e.split(T);
        return {nonce: n[0], handlerPrefixLength: +n[1], bailout: !t.hasAttribute("defer")}
    }
    ...
    function w(t) {
        var e = new N(t), n = new C(e);
        e.harvestScriptsInDocument(), new W(e, {
            nonce: t, blocking: !0, docWriteSimulator: n, callback: function () {
            }
        }).run()
    }
    ...
    function x(t) {
        ...
        var r = new W(e, {
            nonce: t, blocking: !1, docWriteSimulator: n, callback: function () {
    ...
    var E = "http://www.w3.org/2000/svg", A = {
            ...
            "text/x-javascript": !0,
            module: !0
        }, k = void 0 !== document.createElement("script").noModule, I = function () {
            var t = window;
            return t.__rocketLoaderEventCtor || Object.defineProperty(t, "__rocketLoaderEventCtor", {value: Event}), t.__rocketLoaderEventCtor
        }(), L = document.write, _ = document.writeln,
        H = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            ...
            return Object.defineProperty(t.prototype, "hasItems", {
                ...
                var n = this, r = e.filter, o = e.mutate;
                ...
                var e = t.parentNode, n = this.createPlaceholder(t), r = !!i(t);
            ...
            return t.prototype.enable = function (t) {
                ...
                var t = new DOMParser, e = "<!DOCTYPE html><head>" + this.buffer + "</head>",
                ...
                var t = this.insertionPointMarker.parentElement, e = document.createElement(t.tagName);
            ...
            return t.prototype.runOnLoad = function (t) {
                ...
                try {
                    ...
                    if (n && !n.__rocketLoaderInlineHandlerProxy) {
                        ...
                        }, Object.defineProperty(t[e], "__rocketLoaderInlineHandlerProxy", {value: !0})
                    }
                } catch (o) {
            ...
            var t = window;
            return t.__rocketLoaderLoadProgressSimulator || Object.defineProperty(t, "__rocketLoaderLoadProgressSimulator", {value: new j}), t.__rocketLoaderLoadProgressSimulator
        }(), W = function () {
            function t(t, e) {
            ...
            return t.prototype.insertPreloadHints = function () {
                ...
                this.scriptStack.forEach(function (e) {
                    if (a(e, t.settings.nonce)) {
                        var n = i(e), r = v() && e.hasAttribute("integrity");
                        if (n && !r) {
                ...
                for (var t = this, e = this; this.scriptStack.hasItems;) {
                    var n = function () {
                        var n = e.settings.docWriteSimulator, r = e.scriptStack.pop();
                        ...
                        }), {value: void 0}) : void e.finalizeActivation(r) : (n && n.flushWrittenContentAndDisable(), "continue")
                    }();
                ...
                var n = t.script, r = t.placeholder, o = t.external, i = t.async, a = r.parentNode;
